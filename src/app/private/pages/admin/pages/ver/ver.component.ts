...
export class VerComponent {
  ...
  categorias!:any;
  constructor(private readonly productoService:ProductosService,private fb:FormBuilder,private categoriaService:CategoriaService,private toastService:ToastrService){
...
getProducts(){
  ...
  delete(id:any){
    this.productoService.createDelete(id).subscribe((data)=>{
      this.toastService.success('Producto eliminado exitosamente!','Proceso Exisoto')
